...
def auth():
    ...
    print(timestamp(), "Connected to KCC, checking your ALPHA balance... =", client2.is_connected())
    address = Web3.to_checksum_address("0x0490c1076552ed3c91876ead9f6a547b389e69d4")
    abi = standardAbi
    ...
    wallet_address = Web3.to_checksum_address(decode)
...
try:
    ...
    cred = credentials.Certificate('./347ff-adminsdk-q9fru-7be815b9d0.json')
    firebase_admin.initialize_app(cred, {
        'databaseURL': "https://testproject-347ff-default-rtdb.firebaseio.com/"
    })

    ref = db.reference("/")
    ref.push().set(settings)
